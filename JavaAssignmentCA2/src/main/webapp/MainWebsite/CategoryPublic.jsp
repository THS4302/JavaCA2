							...
							<tr
								...
								<td style="width: 20%;">
									...
									<form action="<%=request.getContextPath() %>/AddToCartServlet" method="POST">
    								  ...
    								  <input type="hidden" name="bookid" value="<%= bookArray.get(j)[4] %>"> <!-- Replace "456" with the actual book ID -->
   									  <input type="hidden" name="count" value="1"> <!-- The user can enter the count here -->
